...
def plot_velocity(adata, clusterColumn, threshold=.1, arrow_length=5, arrow_size=2, plot_dir="", prefix="", dpi=240):
    ...
    scv.pl.velocity_embedding_stream(adata, color=clusterColumn, basis='umap', save=prefix+'velocity_embedding_stream.png', legend_loc='none', linewidth=3, arrow_size=1, alpha=0.2, figsize=[9,9], dpi=dpi)
