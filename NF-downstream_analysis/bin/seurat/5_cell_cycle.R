...
# Set paths and load data
{
  if(length(commandArgs(trailingOnly = TRUE)) == 0){
    ...
    plot_path = "./output/NF-downstream_analysis/seurat/5_cell_cycle/plots/"
    rds_path = "./output/NF-downstream_analysis/seurat/5_cell_cycle/rds_files/"
    data_path = "./output/NF-downstream_analysis/seurat/4_sex_filt/rds_files/"
...
cell_cycle_data <- FindClusters(cell_cycle_data, resolution = 0.5)
