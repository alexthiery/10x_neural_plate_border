...
# Set paths and load data
{
  if (opt$runtype == "user"){
    ...
    plot_path = "./output/NF-downstream_analysis/cell_cycle/plots/"
    rds_path = "./output/NF-downstream_analysis/cell_cycle/rds_files/"
...
cell_cycle_data <- readRDS(paste0(data_path, 'sexfilt_data.RDS'))
